...
[TestFixture]
internal class FeData3SyncTool_Tests
{
    ...
    public void Sync_FeData_SyncsAllFeDataFiles()
    {
        ...
        // Act
        FeData3SyncTool.Sync(source, ".txt", _directory);
    ...
    public void Sync_CarPerf_SyncsFeDataFiles_WithPerformanceData()
    {
        ...
        // Act
        FeData3SyncTool.Sync(source, "carp.txt", _directory);
    ...
    public void Sync_CarPerf_DoesNotSyncPerformanceData_WhenSourceIsNotCarpTxt()
    {
        ...
        // Act
        FeData3SyncTool.Sync(source, "carpsim.txt", _directory);
